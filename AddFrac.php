<?php
/**
Description: This program is to insert on postgreSQL database new information of Comunity name and address
@package	FracRB
@subpackage	Settings
...
Copyright (C) 2018 Mario González Jiménez.
	...
	AddFrac.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
$resultStatus = $catalogStatus->addElementFrac($name,$address,$zipCode,$idCountry);
