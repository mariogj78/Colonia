<?php
/**
Description: This program is to generate a dropDown list of Communities added before.
@package	FracRB
@subpackage	Settings
...
Copyright (C) 2018 Mario González Jiménez.
	...
	ListFracMenu.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
if(pg_numrows($resultUser)>0){
	...
	$resultStatus = $catalogStatus->getElementFrac($idFrac);
} else {
	$resultStatus = $catalogStatus->getCatalog("Frac");
}

$catalog = new Catalog;
$catalog->setResultSet($resultStatus);
$catalog->showDropListFromTable("idFrac");
